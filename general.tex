...
\section{Elections}
    Elections for all Central Student Government offices shall be held each March. Each term of office shall begin \temp{August 1, and shall expire on July 31}. Elections shall be administered, overseen, and certified by an Elections Committee, to be overseen by \temp{ELECTIONS COMMITTEE. (Seniors graduate in May)}
